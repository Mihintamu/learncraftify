        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Welcome to LearnCraftify. These Terms of Service govern your use of our website and services. 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Permission is granted to temporarily download one copy of the materials on LearnCraftify's website for personal, 
              non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
            </p>
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
              <li>Modify or copy the materials;</li>
              <li>Use the materials for any commercial purpose or for any public display;</li>
              <li>Attempt to reverse engineer any software contained on LearnCraftify's website;</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              The materials on LearnCraftify's website are provided "as is". LearnCraftify makes no warranties, expressed or implied, 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              In no event shall LearnCraftify or its suppliers be liable for any damages (including, without limitation, damages for loss of 
              data or profit, or due to business interruption) arising out of the use or inability to use the materials on LearnCraftify's website, 
              even if LearnCraftify or a LearnCraftify authorized representative has been notified orally or in writing of the possibility of such damage.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              The materials appearing on LearnCraftify's website could include technical, typographical, or photographic errors. 
              LearnCraftify does not warrant that any of the materials on its website are accurate, complete, or current. 
              LearnCraftify may make changes to the materials contained on its website at any time without notice.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              These Terms of Service are effective unless and until terminated by either you or LearnCraftify. 
